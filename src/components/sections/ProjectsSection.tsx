...
const projects = [
  ...
  },
  {
    ...
    description: "Educational platform homepage featuring trusted resources, intuitive navigation, and personalized learning paths, designed with user research and team collaboration.",
    icon: Layout,
    tags: ["Team Lead", "Competitavie Analysis", "Team Collaboration"],
    color: "from-rose-500 to-red-500",
    link:"https://www.figma.com/proto/8fBCjPPy1pl8FVlpqQaPNW/Home-Page-Redesign?page-id=0%3A1&node-id=7-3114&viewport=83%2C309%2C0.13&t=XFkTfHXnMLQ0EWSJ-1&scaling=min-zoom&content-scaling=fixed",
  },
